...
== Always be on time
Always calculate for unforeseen events and leave early if you can. This will reflect well on your xref:work.asciidoc[WORK] ethic.
...
Learning to estimate how long things take you will be useful for xref:moneyascii.doc[MONEY] management estimations, expenses estimation, and planning. Once again, wear a wristwatch.
