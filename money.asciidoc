...
=== Stick to your investment strategies and goals

But revise them periodically, market conditions change
...
I've learned that low cost indexes are a great option to expose yourself worry free to equities. I recommend having a portion on an index that tracks a subset of the S&P which covers the companies with the lowest volatility while at the same time paying monthly dividends (SPHD)
