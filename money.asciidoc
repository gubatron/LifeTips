...
== Learn how to use debt judiciously under different economic circumstances

Always make sure you are not overleveraged, make sure you will be able to pay before you enter into any debt contract.

When interests are low this means cheap (or even free) money, which can be leveraged to make different investments (real estate, markets), make sure you don't borrow more than 1/10th of your collateral, at worst borrow up to 1/5th.

When the economy is turning inflationary there might be still a window of low interests (before the central banks raise them) to obtain cash very cheap, as inflation makes money less valuable your interest rate payments will become easier and easier to pay if you manage to raise your income to match the inflationary reality. If the yearly inflation rate is higher than the credit rate, your real interest rate will be lower than your nominal rate.
